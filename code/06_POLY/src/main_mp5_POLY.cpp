...
/*
void    Base::virtualAndOverridden(){
...
// -------------------
void Derived_1::nonVirtualMethod() {
    std::cout << "Derived_1::nonVirtualMethod" << std::endl;
}

void Derived_1::virtualMethod() {
    std::cout << "Derived_1::virtualMethod" << std::endl;
}


/*
void    Derived_1::virtualAndOverridden(){
...
// -------------------
void Derived_2::nonVirtualMethod() {
    std::cout << "Derived_2::nonVirtualMethod" << std::endl;
}

void Derived_2::virtualMethod() {
...
typedef void (*funcPointer_void_void)();
